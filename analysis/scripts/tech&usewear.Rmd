---
title: "SOM3 - Read and plot data"
author: "Paixao et al. 2021. Functional analysis of the Middle Paleolithic Ground Stone Tools from Unit V of Nesher Ramla (Central Levante): the application of a multi-scale use-wear approach. Quaternary International"
date: "`r Sys.time()`"
output:
...
This R markdown document reads, summarizes and plots data for: *Paixao et al. 2021. Functional analysis of the Middle Paleolithic Ground Stone Tools from Unit V of Nesher Ramla (Central Levante): the application of a multi-scale use-wear approach. Quaternary International*. The document contains:
